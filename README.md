...
- 機能説明<br>
  ...
  - アカウント作成機能<br>
  - ホーム画面<br>
  ユーザー自身がお気に入りしているジャンルと所属しているグループを見ることができます<br>
  右上のアイコンからアカウントの変更、ログアウト、グループ希望確認（下記説明）ができます<br>
